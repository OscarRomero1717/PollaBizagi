...
import { UserPredictionsPageComponent } from './features/leaderboard/user-predictions-page/user-predictions-page.component';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivate: [authGuard],
        component: UserPredictionsPageComponent
      },
      {
        path: 'admin',
